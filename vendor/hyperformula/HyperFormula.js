...
import { buildCustomFunctionDetails, buildCustomFunctionListEntry, buildFunctionDetails, buildFunctionListEntry } from './interpreter/functionMetadata/buildFunctionDescriptions';
...
export class HyperFormula {
     ...
     */
    static resolveFunctionMetadata(functionId, plugin) {
        var _a, _b;
        ...
        const metadataKey = (_b = (_a = plugin.aliases) === null || _a === void 0 ? void 0 : _a[functionId]) !== null && _b !== void 0 ? _b : functionId;
     ...
     */
    static buildAvailableFunctions(functionRegistry, language) {
        const translate = (id) => language.getMaybeFunctionTranslation(id);
     ...
     * @param {TranslationPackage} language - the translation package to translate the names under
     */
    static buildFunctionDetailsFor(functionId, functionRegistry, language) {
    ...
    getAvailableFunctions() {
        return HyperFormula.buildAvailableFunctions(this._functionRegistry, 
