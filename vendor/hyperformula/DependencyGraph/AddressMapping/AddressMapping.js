...
export class AddressMapping {
     ...
     */
    addSheetWithStrategy(sheetId, strategy, options = { throwIfSheetAlreadyExists: true }) {
     ...
     */
    addSheetAndSetStrategyBasedOnBoundaries(sheetId, sheetBoundaries, options = { throwIfSheetAlreadyExists: true }) {
