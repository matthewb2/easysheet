 ...
 */
export function findLastOccurrenceInOrderedRange(searchKey, range, { searchCoordinate, orderingDirection, ifNoMatch }, dependencyGraph) {
     ...
     */
    const findNextNonEmptyIndex = (fromIndex) => {
