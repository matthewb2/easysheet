 ...
 */
import { CUSTOM_FUNCTION_CATEGORY } from './FunctionDescription';
/**
 ...
 */
export function isParameterOptional(arg) {
    return (arg === null || arg === void 0 ? void 0 : arg.optionalArg) === true || (arg === null || arg === void 0 ? void 0 : arg.defaultValue) !== undefined;
}
/**
 ...
 */
export function clampRepeatLastArgs(repeatLastArgs, parameterCount) {
 ...
 */
function buildPositionalParameters(args) {
 ...
 * @param {FunctionArgument[]} args - the implementation's parameters, in declaration order
 */
function buildDocumentedParameters(canonicalName, doc, args) {
 ...
 */
function resolveName(canonicalName, translate) {
 ...
 */
export function buildFunctionListEntry(canonicalName, doc, translate, aliasOf) {
    return Object.assign(Object.assign({ localizedName: resolveName(canonicalName, translate), canonicalName }, (aliasOf !== undefined ? { aliasOf } : {})), { category: doc.category, shortDescription: doc.shortDescription });
}
/**
 ...
 * @param {string | undefined} aliasOf - the alias target's id when `canonicalName` is an alias, else `undefined`
 */
export function buildFunctionDetails(canonicalName, doc, metadata, translate, aliasOf) {
    var _a;
    const parameters = buildDocumentedParameters(canonicalName, doc, (_a = metadata.parameters) !== null && _a !== void 0 ? _a : []);
    return Object.assign(Object.assign({ localizedName: resolveName(canonicalName, translate), canonicalName }, (aliasOf !== undefined ? { aliasOf } : {})), { category: doc.category, shortDescription: doc.shortDescription, parameters, repeatLastArgs: clampRepeatLastArgs(metadata.repeatLastArgs, parameters.length), documentationUrl: doc.documentationUrl, examples: [...doc.examples] });
}
/**
 ...
 * @param {string | undefined} aliasOf - the alias target's id when `canonicalName` is an alias, else `undefined`
 */
export function buildCustomFunctionListEntry(canonicalName, translate, aliasOf) {
    ...
    return Object.assign(Object.assign({ localizedName: resolveName(canonicalName, translate), canonicalName }, (aliasOf !== undefined ? { aliasOf } : {})), { category: CUSTOM_FUNCTION_CATEGORY });
}
/**
 ...
 * @param {string | undefined} aliasOf - the alias target's id when `canonicalName` is an alias, else `undefined`
 */
export function buildCustomFunctionDetails(canonicalName, metadata, translate, aliasOf) {
    var _a;
    const parameters = buildPositionalParameters((_a = metadata.parameters) !== null && _a !== void 0 ? _a : []);
    ...
    return Object.assign(Object.assign({ localizedName: resolveName(canonicalName, translate), canonicalName }, (aliasOf !== undefined ? { aliasOf } : {})), { category: CUSTOM_FUNCTION_CATEGORY, parameters, repeatLastArgs: clampRepeatLastArgs(metadata.repeatLastArgs, parameters.length) });
}
