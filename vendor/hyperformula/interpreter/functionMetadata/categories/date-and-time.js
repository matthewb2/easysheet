 ...
 */
/**
 * Catalogue entries for the "Date and time" category. Authored here: this catalogue is the source of
 * truth for the function metadata API, and `docs/guide/built-in-functions.md` is generated from it.
 */
export const DATE_AND_TIME_DOCS = {
    DATE: {
    ...
    EDATE: {
        ...
        parameters: [{ name: 'start_date', description: 'The date value to shift.' }, { name: 'months', description: 'The number of months to shift start_date by; negative values shift backwards.' }],
        documentationUrl: 'https://hyperformula.handsontable.com/docs/guide/built-in-functions.html',
    ...
    EOMONTH: {
        ...
        parameters: [{ name: 'start_date', description: 'The date value to start counting from.' }, { name: 'months', description: 'The number of months to add to start_date before finding the end of that month; negative values go backwards.' }],
        documentationUrl: 'https://hyperformula.handsontable.com/docs/guide/built-in-functions.html',
    ...
    TIMEVALUE: {
        category: 'Date and time',
        shortDescription: 'Parses time_string and returns a number that represents it as a fraction of a full day.<br>Accepts formats set by the [`timeFormats`](https://hyperformula.handsontable.com/docs/api/interfaces/configparams.html#timeformats) option.',
