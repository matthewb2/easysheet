 ...
 */
/**
 * Catalogue entries for the "Statistical" category. Authored here: this catalogue is the source of
 * truth for the function metadata API, and `docs/guide/built-in-functions.md` is generated from it.
 */
export const STATISTICAL_DOCS = {
    AVEDEV: {
    ...
    'BETA.INV': {
        category: 'Statistical',
        shortDescription: 'Returns the inverse of the beta distribution value.',
