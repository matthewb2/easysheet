...
import { equalSimpleCellAddress, isColOrRowInvalid, simpleCellAddress } from './Cell';
import { CellContent } from './CellContentParser';
import { ClipboardCellType } from './ClipboardOperations';
import { ContentChanges } from './ContentChanges';
import { ArrayFormulaVertex, EmptyCellVertex, ScalarFormulaVertex, ParsingErrorVertex, SparseStrategy, ValueCellVertex, } from './DependencyGraph';
...
export class Operations {
    ...
    ensureItIsPossibleToMoveCells(sourceLeftCorner, width, height, destinationLeftCorner) {
        if (isColOrRowInvalid(sourceLeftCorner) ||
        ...
        if (parsedCellContent instanceof CellContent.Formula) {
            ...
            if (errors.length > 0) {
                ...
                try {
                    ...
                    const parsingError = { type: ParsingErrorType.InvalidRangeSize, message: 'Invalid range size.' };
