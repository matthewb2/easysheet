...
function defaultParseToTime(timeItems, timeFormat) {
    ...
    const { itemsCount, hourItem, minuteItem, secondItem, } = memoizedParseTimeFormat(timeFormat);
    let ampm = undefined;
...
function defaultParseToDate(dateItems, dateFormat) {
    ...
    const { itemsCount, dayItem, monthItem, shortYearItem, longYearItem, } = memoizedParseDateFormat(dateFormat);
