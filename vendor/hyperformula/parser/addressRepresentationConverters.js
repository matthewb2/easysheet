 ...
 */
export const cellAddressFromString = (stringAddress, baseAddress, resolveSheetReference) => {
...
export const columnAddressFromString = (stringAddress, baseAddress, resolveSheetReference) => {
...
export const rowAddressFromString = (stringAddress, baseAddress, resolveSheetReference) => {
 ...
 */
export const simpleCellAddressFromString = (resolveSheetReference, stringAddress, contextSheetId) => {
...
export const simpleCellRangeFromString = (resolveSheetReference, stringAddress, contextSheetId) => {
